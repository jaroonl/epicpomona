...
const events: Event[] = [
  {
    ...
    image: "/UpcomingEventsImages/broomball.png",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Mauris ut tellus ultrices a habitant vitae at.",
    image: "/UpcomingEventsImages/fall-retreat.png",
    location: "3801 W Temple Ave",
    time: "Time",
    day: "Weekday",
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Mauris ut tellus ultrices a habitant vitae at.",
    image: "/UpcomingEventsImages/feast-for-five.png",
    location: "3801 W Temple Ave",
    time: "Time",
    day: "Weekday",
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Mauris ut tellus ultrices a habitant vitae at.",
    image: "/UpcomingEventsImages/halloween-party.png",
    location: "3801 W Temple Ave",
    time: "Time",
    day: "Weekday",
  },
  ...
  return (
    <div className="w-full min-h-screen bg-white relative">
      ...
      <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[719px]">
        {/* Background Image */}
        <Image
          src="/UpcomingEventsImages/beachday.jpg"
          alt="Hero background"
          fill
...
<div className="relative w-full flex justify-center py-8 sm:py-12 lg:py-16 px-4">
  <div className="relative w-full max-w-[1152px]">
    <Image
      src="/UpcomingEventsImages/fall-retreat-banner.jpg"
      alt="Fall Retreat"
      width={820}
      height={524}
