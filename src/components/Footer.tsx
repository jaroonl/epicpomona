const Footer = () => {
  return (
    <footer
      className="flex justify-center items-center py-8 px-4 sm:px-6 lg:px-8 border-t border-[rgba(117,117,117,1)]"
      style={{ backgroundColor: "#1D2046", minHeight: "230px" }}
    >
      <div className="flex w-full max-w-[1152px] justify-between items-start">
        {/* Navigation Columns */}
        <div className="flex flex-col lg:flex-row justify-center items-start gap-8 lg:gap-12 p-1.5 w-full">
          {/* Socials */}
          <div className="flex flex-col items-start gap-3 w-full lg:w-[158px]">
            ...
            <div className="flex flex-col gap-3 w-full">
              <a
                ...
                className="text-[16px] font-normal leading-[140%] font-outfit hover:text-white transition-colors flex items-center gap-2"
                style={{ color: "rgba(243, 243, 243, 1)" }}
              >
                <svg
                  width="20"
              ...
              <a
                ...
                className="text-[16px] font-normal leading-[140%] font-outfit hover:text-white transition-colors flex items-center gap-2 underline"
                style={{ color: "rgba(243, 243, 243, 1)" }}
              >
                <svg
                  width="20"
          ...
          {/* Get Connected */}
          <div className="flex flex-col items-start gap-3 w-full lg:w-[189px]">
            <div className="flex flex-col items-start gap-2.5 self-stretch pb-4">
              <h4
                className="text-[18px] font-semibold leading-[140%] font-outfit self-stretch"
                style={{ color: "rgba(243, 243, 243, 1)" }}
          ...
          {/* Resources */}
          <div className="flex flex-col items-start gap-3 w-full lg:w-[123px]">
            <div className="flex flex-col items-start gap-2.5 self-stretch pb-4">
              <h4
                className="text-[18px] font-semibold leading-[140%] font-outfit self-stretch"
                style={{ color: "rgba(243, 243, 243, 1)" }}
          ...
          {/* Support/Give */}
          <div className="flex flex-col items-start gap-3 w-full lg:w-[147px]">
            <div className="flex flex-col items-start gap-2.5 self-stretch pb-4">
              <h4
                className="text-[18px] font-semibold leading-[140%] font-outfit self-stretch"
                style={{ color: "rgba(243, 243, 243, 1)" }}
