...
export default function EventCard({ event }: EventCardProps) {
  ...
  // Pick event.image if it exists, otherwise fallback
  const imageSrc =
          ...
          <div className="card-footer">
            <div className="card-info">
              <div className="card-details">
                ...
                {/* Time (day is okay alone; time is optional) */}
                {(event.day || hasTime) && (
                  <div className="info-item">
                    <ClockIcon />
                    <div className="info-text">
                      {event.day && <span className="font-bold">{event.day}</span>}
                      {event.day && hasTime && <span className="font-normal">: {event.time}</span>}
                      {!event.day && hasTime && <span className="font-normal">{event.time}</span>}
                    </div>
                  </div>
                )}
        ...
        <div className="card-side card-back">
          ...
          <div className="card-back-info">
            ...
            <div className="info-section">
              ...
              <p className="info-content">{whenText}</p>
            </div>
